...
const BarberDetail = () => {
  return (
    <>
      ...
      <div className="flex">
        <div className="col-md-4 -mt-32 w-[330px] h-[337px]  flex justify-end z-20">
          <img src={man} />
        </div>
        <div className="col-md-8 flex">
          <div className="col-md-7  flex flex-col justify-evenly pl-20 ">
          ...
          <div className="col-md-5 pl-20 pt-4 flex flex-col background-image-scissors ">
