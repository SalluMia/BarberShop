    ...
    <div className="bg-[#C5AC80]">
      ...
      <div className="relative w-full container mt-20 ">
        ...
        <div
          ...
          className="absolute -left-[50px] w-[54px] h-[54px] bg-white flex justify-center items-center rounded-full sm:visible top-1/3  transform -translate-y-1/2 text-gray-700 hover:text-gray-900 transition duration-300 ease-in-out focus:outline-none"
        >
        ...
        <div
          ...
          className="absolute bg-white  rounded-full w-[54px] h-[54px] flex justify-center items-center -right-[50px] sm:visible top-1/3  transform -translate-y-1/2 text-gray-700 hover:text-gray-900 transition duration-300 ease-in-out focus:outline-none"
        >
