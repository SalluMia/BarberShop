    ...
    <div className="bg-[#C5AC80]">
      ...
      <div className="relative w-full container mt-20 ">
        <AliceCarousel {...options} ref={(el) => (carousel = el)}>
          {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((image, index) => (
            <div className="flex justify-center items-center ">
              <div className=" w-[269px] h-[390px] border-none bg-white  rounded-3xl">
                ...
                <div className="">
                  ...
                  <div className="flex  ml-3 mt-3  rounded-3xl">
        ...
        <div
          ...
          className="absolute md:left-[-5%] left-[0%] w-[54px] h-[54px] bg-white flex justify-center items-center rounded-full sm:visible top-1/3  transform -translate-y-1/2 text-gray-700 hover:text-gray-900 transition duration-300 ease-in-out focus:outline-none"
        >
        ...
        <div
          ...
          className="absolute bg-white  rounded-full w-[54px] h-[54px] flex justify-center items-center md:right-[-5%] right-[0%] sm:visible top-1/3  transform -translate-y-1/2 text-gray-700 hover:text-gray-900 transition duration-300 ease-in-out focus:outline-none"
        >
